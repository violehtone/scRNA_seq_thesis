...
plotReducedDim(denoised.sce, colour_by = "sample", dimred = "UMAP") + ggtitle("Primary data: UMAP with clusters (k=180)") + theme(plot.title = element_text(size = 16, face = "bold"))
...
plotReducedDim(denoised.sce.cc, colour_by = "sample", dimred = "PCA") + ggtitle("Primary data (cc corrected) clustering: PCA (k=10)") + theme(plot.title = element_text(size = 16, face = "bold"))

plotReducedDim(denoised.sce.cc, colour_by = "sample", dimred = "UMAP") + ggtitle("Primary data (cc corrected) clustering: UMAP with clusters (k=10)") + theme(plot.title = element_text(size = 16, face = "bold"))

plotTSNE(denoised.sce.cc, colour_by = "sample") + ggtitle("Primary data (cc corrected) clustering: TSNE (k=10)") + theme(plot.title = element_text(size = 16, face = "bold"))
