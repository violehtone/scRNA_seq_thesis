...
# Plot results
plotReducedDim(denoised.sce.deMicheli, colour_by = "injury", dimred = "force")
plotReducedDim(denoised.sce.deMicheli, colour_by = "injury", dimred = "PCA")

denoised.sce.deMicheli <- runUMAP(denoised.sce.deMicheli, dimred = "PCA", n_dimred = dimensions.deMicheli)
plotReducedDim(denoised.sce.deMicheli, colour_by = "injury", dimred = "UMAP")

denoised.sce.deMicheli <- runTSNE(denoised.sce.deMicheli, dimred = "PCA")
plotTSNE(denoised.sce.deMicheli, colour_by = "injury")
```
