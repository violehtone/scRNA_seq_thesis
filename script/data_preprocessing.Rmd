...
#saveRDS(g2m.genes.mouse, file = "./../saved/cc_g2m_genes_mouse")
#saveRDS(s.genes.mouse, file = "./../saved/cc_gs_genes_mouse")
...
# Save cc objects
#saveRDS(sce.deMicheli.cc, file = "./../saved/sce_deMicheli_cc")
#saveRDS(sce.dellOrso.cc, file = "./../saved/sce_dellOrso_cc")
...
percent.var <- attr(reducedDim(sce.cc, "PCA"), "percentVar")
percent.var.cc <- attr(reducedDim(sce.cc, "PCA_cc"), "percentVar")
...
par(mfrow=c(1,2))
plot(percent.var, xlab = "PC", ylab = "Variance explained (%)", main = "Variance explained by each PC", sub = "Primary data")
abline(v = chosen.elbow, col = "red")
plot(percent.var.cc, xlab = "PC", ylab = "Variance explained (%)", sub = "Primary data (cc corrected)")
...
# Compute the variance explained by each PC
percent.var.deMicheli <- attr(reducedDim(sce.deMicheli.cc, "PCA"), "percentVar")
percent.var.deMicheli.cc <- attr(reducedDim(sce.deMicheli.cc, "PCA_cc"), "percentVar")

chosen.elbow.deMicheli <- PCAtools::findElbowPoint(percent.var.deMicheli)
chosen.elbow.deMicheli.cc <- PCAtools::findElbowPoint(percent.var.deMicheli.cc)
chosen.elbow.deMicheli
chosen.elbow.deMicheli.cc

# Plot variance explained by PCs
par(mfrow=c(1,2))
plot(percent.var.deMicheli, xlab = "PC", ylab = "Variance explained (%)", main = "Variance explained by each PC", sub = "De Micheli data")
abline(v=chosen.elbow.deMicheli, col = "red")
plot(percent.var.deMicheli.cc, xlab = "PC", ylab = "Variance explained (%)", sub = "De Micheli data (cc corrected)")
abline(v=chosen.elbow.deMicheli.cc, col = "red")
...
# Compute the variance explained by each PC
percent.var.dellOrso <- attr(reducedDim(sce.dellOrso.cc, "PCA"), "percentVar")
percent.var.dellOrso.cc <- attr(reducedDim(sce.dellOrso.cc, "PCA_cc"), "percentVar")

chosen.elbow.dellOrso <- PCAtools::findElbowPoint(percent.var.dellOrso)
chosen.elbow.dellOrso.cc <- PCAtools::findElbowPoint(percent.var.dellOrso.cc)
chosen.elbow.dellOrso
chosen.elbow.dellOrso.cc

# Plot variance explained by PCs
par(mfrow=c(1,1))
plot(percent.var.dellOrso, xlab = "PC", ylab = "Variance explained (%)",  main = "Variance explained by each PC", sub = "Dell'Orso data")
abline(v=chosen.elbow.dellOrso, col = "red")
plot(percent.var.dellOrso.cc, xlab = "PC", ylab = "Variance explained (%)", sub = "Dell'Orso data (cc corrected)")
abline(v=chosen.elbow.dellOrso.cc, col = "red")
