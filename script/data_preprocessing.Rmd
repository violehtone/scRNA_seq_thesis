...
gridExtra::grid.arrange(p.force.10, p.pca.10, p.umap.10, p.tsne.10, nrow = 2, ncol = 2)
...
gridExtra::grid.arrange(p.sub.control, p.sub.control.cc, 
                        p.sub.cap50, p.sub.cap50.cc,
                        p.sub.cap50r4h, p.sub.cap50r4h.cc,
                        p.sub.cap50r8h, p.sub.cap50r8h.cc,
                        p.sub.cap50r16h, p.sub.cap50r16h.cc,
                        ncol = 2)
```

#### 12.3.2 Marker gene detection
```{r marker-gene-detection, eval=FALSE, echo=FALSE}
...
pheatmap(log10(tab+10), main = "Original data vs. CC corrected (k=10)", color=viridis::viridis(100), silent=TRUE)
