...
#save as pdf
pdf("./../saved/gimp_heatmap_primary_metabolic_modules.pdf")
p.primary.modules
dev.off()
```
...
#save as pdf
pdf("./../saved/gimp_heatmap_primary_metabolic_pathways.pdf")
p.primary.pathways
dev.off()

pdf("./../saved/gimp_heatmap_primary_metabolic_pathways_names.pdf")
p.primary.pathways.names
dev.off()
```
...
#save as pdf
pdf("./../saved/gimp_heatmap_deMicheli_metabolic_modules.pdf")
p.deMicheli.modules
dev.off()
```
...
#save as pdf
pdf("./../saved/gimp_heatmap_deMicheli_metabolic_pathways.pdf")
p.deMicheli.pathways
dev.off()

pdf("./../saved/gimp_heatmap_deMicheli_metabolic_pathways_names.pdf")
p.deMicheli.pathways.names
dev.off()
```
...
#save as pdf
pdf("./../saved/gimp_heatmap_deMicheli_metabolic_modules_f.pdf")
p.deMicheli.modules.f
dev.off()
```
...
#save as pdf
pdf("./../saved/gimp_heatmap_deMicheli_metabolic_pathways_f.pdf")
p.deMicheli.pathways.f
dev.off()

pdf("./../saved/gimp_heatmap_deMicheli_metabolic_pathways_f_names.pdf")
p.deMicheli.pathways.names.f
dev.off()
```
...
# Save as pdf
pdf("./../saved/gimp_heatmap_dellOrso_metabolic_modules.pdf")
p.dellOrso.modules
dev.off()
```
...
# Save as pdf
pdf("./../saved/gimp_heatmap_dellOrso_metabolic_pathways.pdf")
p.dellOrso.pathways
dev.off()

pdf("./../saved/gimp_heatmap_dellOrso_metabolic_pathways_names.pdf")
p.dellOrso.pathways.names
dev.off()
```
...
# Save as pdf
pdf("./../saved/gimp_heatmap_dellOrso_metabolic_modules_f.pdf")
p.dellOrso.modules.f
dev.off()
```
...
# Save as pdf
pdf("./../saved/gimp_heatmap_dellOrso_metabolic_pathways_f.pdf")
p.dellOrso.pathways.f
dev.off()

pdf("./../saved/gimp_heatmap_dellOrso_metabolic_pathways_f_names.pdf")
p.dellOrso.pathways.names.f
dev.off()
```
