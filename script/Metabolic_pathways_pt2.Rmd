...
# Get gimp & module objects
gimp.dellOrso.module <- readRDS("./../saved/R_objects/gimp_dellOrso_module")
modules.dellOrso.module <- readRDS("./../saved/R_objects/modules_dellOrso_module")
...
# Get gimp & module objects
gimp.dellOrso.pathway <- readRDS("./../saved/R_objects/gimp_dellOrso_pathway")
modules.dellOrso.pathway <- readRDS("./../saved/R_objects/modules_dellOrso_pathway")
...
```{r compute-dellOrso-module-importances, eval=FALSE}
# Create expression and sample objects
expression.dellOrso.module <- as.matrix(t(logcounts(sce.dellOrso.module)))
...
saveRDS(gimp.dellOrso.module, file = "./../saved/R_objects/gimp_dellOrso_module")
...
saveRDS(modules.dellOrso.module, file = "./../saved/R_objects/modules_dellOrso_module")
```


#### 4.2.8 Dell'Orso data - pathways
```{r compute-dellOrso-pathway-importances, eval=FALSE}
# Create expression and sample objects
expression.dellOrso.pathway <- as.matrix(t(logcounts(sce.dellOrso.pathway)))
...
saveRDS(gimp.dellOrso.pathway, file = "./../saved/R_objects/gimp_dellOrso_pathway")
...
saveRDS(modules.dellOrso.pathway, file = "./../saved/R_objects/modules_dellOrso_pathway")
```
...
**Save as pdf**
```{r trajectory-heatmap-dellOrso-data-modules-pdf, eval=FALSE}
# Save as pdf
pdf("./../saved/figures/gimp_heatmap_dellOrso_metabolic_modules.pdf")
p.dellOrso.modules
dev.off()
```
...
# Plot by pathway names as row values
## Get pathway names
sce.dellOrso.pathway.important <- sce.dellOrso.pathway[(rownames(sce.dellOrso.pathway) %in% modules.dellOrso.pathway$feature), ]

## Sort objects in the same order
sce.dellOrso.pathway.important <- sce.dellOrso.pathway.important[modules.dellOrso.pathway$feature, ]
expr_sel.dellOrso.pathway.name <- expr_sel.dellOrso.pathway[, modules.dellOrso.pathway$feature]

# Change pathway IDs to pathway names
rownames(sce.dellOrso.pathway.important) <- rowData(sce.dellOrso.pathway.important)$pathway_name
colnames(expr_sel.dellOrso.pathway.name) <- rowData(sce.dellOrso.pathway.important)$pathway_name
modules.dellOrso.pathway.name <- modules.dellOrso.pathway
modules.dellOrso.pathway.name$feature <- rowData(sce.dellOrso.pathway.important)$pathway_name

## Make the plot
p.dellOrso.pathways.names <- draw_trajectory_heatmap(expr_sel.dellOrso.pathway.name, 
                                                      time = traj.dellOrso$time,
                                                      progression_group = group_name.dellOrso.pathway,
                                                      modules = modules.dellOrso.pathway.name,
                                                      show_labels_row = TRUE,
                                                      fontsize_row = 5,
                                                      fontsize = 4)

p.dellOrso.pathways.names

```


**Save as pdf**
```{r trajectory-heatmap-dellOrso-data-pathways-pdf, eval=FALSE}
# Save as pdf
pdf("./../saved/figures/gimp_heatmap_dellOrso_metabolic_pathways.pdf")
p.dellOrso.pathways
dev.off()

pdf("./../saved/figures/gimp_heatmap_dellOrso_metabolic_pathways_names.pdf")
p.dellOrso.pathways.names
dev.off()
```
...
if(!exists("modules.dellOrso.module")) {modules.dellOrso.module <- readRDS("./../saved/R_objects/modules_dellOrso_module")}
if(!exists("modules.dellOrso.pathway")) {modules.dellOrso.pathway <- readRDS("./../saved/R_objects/modules_dellOrso_pathway")}
