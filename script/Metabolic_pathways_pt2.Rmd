...
traj.dellOrso.time.module <-  traj.dellOrso$time[names(traj.dellOrso$time) %in% colnames(sce.dellOrso.module)]
...
gimp.dellOrso.module <- gene_importances(x = expression.dellOrso.module,
                                        time = traj.dellOrso.time.module,
                                        num_permutations = 10,
                                        num_threads = 8)
...
traj.dellOrso.time.pathway <-  traj.dellOrso$time[names(traj.dellOrso$time) %in% colnames(sce.dellOrso.pathway)]
...
gimp.dellOrso.pathway <- gene_importances(x = expression.dellOrso.pathway,
                                        time = traj.dellOrso.time.pathway,
                                        num_permutations = 10,
                                        num_threads = 8)
