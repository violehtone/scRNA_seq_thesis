...
saveRDS(gimp.primary.pathway, file = "gimp_primary_pathway")
...
saveRDS(modules.primary.pathway, file = "modules_primary_pathway")
```
...
saveRDS(gimp.deMicheli.module, file = "gimp_deMicheli_module")
...
saveRDS(modules.deMicheli.module, file = "modules_deMicheli_module")
```
...
saveRDS(gimp.deMicheli.pathway, file = "gimp_deMicheli_pathway")
...
saveRDS(modules.deMicheli.pathway, file = "modules_deMicheli_pathway")
```
...
saveRDS(gimp.deMicheli.module, file = "gimp_deMicheli_module_no_muscle")
...
saveRDS(modules.deMicheli.module, file = "modules_deMicheli_module_no_muscle")
```
...
saveRDS(gimp.deMicheli.pathway, file = "gimp_deMicheli_pathway_no_muscle")
...
saveRDS(modules.deMicheli.pathway, file = "modules_deMicheli_pathway_no_muscle")
```
...
saveRDS(gimp.dellOrso.module, file = "gimp_dellOrso_module")
...
saveRDS(modules.dellOrso.module, file = "modules_dellOrso_module")
```
...
saveRDS(gimp.dellOrso.pathway, file = "gimp_dellOrso_pathway")
...
saveRDS(modules.dellOrso.pathway, file = "modules_dellOrso_pathway")
```
...
saveRDS(gimp.dellOrso.module, file = "gimp_dellOrso_module_no_pm")
...
saveRDS(modules.dellOrso.module, file = "modules_dellOrso_module_no_pm")
```
...
saveRDS(gimp.dellOrso.pathway, file = "gimp_dellOrso_pathway_no_pm")
...
saveRDS(modules.dellOrso.pathway, file = "modules_dellOrso_pathway_no_pm")
```
