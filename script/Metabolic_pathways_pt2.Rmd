...
# Plot the venn diagrams and print the intersections between datasets
plot(venn.modules, main = "Metabolic modules: all cell types")
print(attr(venn.modules ,"intersections"))

plot(venn.pathways, main = "Metabolic pathways: all cell types")
print(attr(venn.pathways ,"intersections"))

plot(venn.modules.f, main = "Metabolic modules: no mature skeletal muscle or primary myoblasts")
print(attr(venn.modules.f ,"intersections"))

plot(venn.pathways.f, main = "Metabolic pathways: no mature skeletal muscle or primary myoblasts")
