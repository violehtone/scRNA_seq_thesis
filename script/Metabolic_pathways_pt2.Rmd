...
pheatmap(logFCs, breaks=seq(-5, 5, length.out=101), main = "Metabolic marker modules (t-test): Control vs. other samples (metabolic genes)", fontsize_row = 12)
```
...
pheatmap(logFCs, breaks=seq(-5, 5, length.out=101), main = "Metabolic marker pathways (t-test): Control vs. other samples (metabolic genes)", fontsize_row = 12)
```
