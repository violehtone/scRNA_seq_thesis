...
# Make plots
p.primary <- ggplot(df.modules.primary, aes(x = Scorpius_module, y = frequency)) +
...
p.deMicheli <- ggplot(df.modules.deMicheli, aes(x = Scorpius_module, y = frequency)) +
  geom_bar(aes(fill = KEGG_module), stat = "identity", position = position_dodge(1)) +
  ggtitle("Frequency of KEGG modules in different trajectory modules",
...
p.dellOrso <- ggplot(df.modules.dellOrso, aes(x = Scorpius_module, y = frequency)) +
  geom_bar(aes(fill = KEGG_module), stat = "identity", position = position_dodge(1)) +
  ggtitle("Frequency of KEGG modules in different trajectory modules",
