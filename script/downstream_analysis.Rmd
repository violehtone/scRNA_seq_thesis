...
plotReducedDim(cap50, colour_by = "sample", dimred = "UMAP") + ggtitle("Cap 50 sample - sample")
plotReducedDim(cap50, colour_by = "cluster", dimred = "UMAP") + ggtitle("Cap 50 sample - cluster")
...
**CC-corrected data**
```{rDE-analysis-of-cap50-sample-cc}
...
# Plot UMAP plots to inspect clusters
plotReducedDim(denoised.sce.cc, colour_by = "cluster.cc", dimred = "UMAP_cc") + ggtitle("Primary data (cc corrected) - cluster")
plotReducedDim(cap50.cc, colour_by = "cluster.cc", dimred = "UMAP_cc") + ggtitle("Cap 50 sample (cc corrected) - cluster")

# Plot only clusters 3 and 4
cap50.cc.f <- cap50.cc[, cap50$cluster.cc == c(3,4)]
plotReducedDim(cap50.cc.f, colour_by = "cluster.cc", dimred = "UMAP_cc") + ggtitle("Cap 50 sample (cc corrected) - only clusters 3 and 4")
