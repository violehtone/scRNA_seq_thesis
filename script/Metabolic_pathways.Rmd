...
**Dell'Orso**
```{r dellOrso-annotation-diagnostic-plots-metabolic-genes, eval=FALSE}
# Score heatmap
plotScoreHeatmap(pred.dellOrso.m, annotation_col = as.data.frame(colData(denoised.sce.m)[, "sample", drop = FALSE]), width = 10)

# Remove low-quality cells
to.remove <- pruneScores(pred.dellOrso.m, min.diff.next = 0.1)
...
# Markers
all.markers.dellOrso <- metadata(pred.dellOrso.m)$de.genes
denoised.sce.m$cell_type_dellOrso.m <- pred.dellOrso.m$labels
```
...
#######################
# pdf("./../saved/figures/cell_annotation_heatmap_dellOrso_metabolic_genes_hom.pdf")
# plotHeatmap(denoised.sce.m,
#             order_columns_by="cell_type_dellOrso.m",
#             features=unique(unlist(all.markers.dellOrso$homeostatic_MuSCs)),
#             fontsize_row = 5)
# dev.off()
# 
# pdf("./../saved/figures/cell_annotation_heatmap_dellOrso_metabolic_genes_inj60.pdf")
# plotHeatmap(denoised.sce.m,
#             order_columns_by="cell_type_dellOrso.m",
...
# dev.off()
# 
# pdf("./../saved/figures/cell_annotation_heatmap_dellOrso_metabolic_genes_pmb.pdf")
# plotHeatmap(denoised.sce.m,
#             order_columns_by="cell_type_dellOrso.m",
