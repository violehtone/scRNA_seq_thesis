...
if(!exists("modules.deMicheli.m.f")) {modules.deMicheli.m.f <- readRDS("./../saved/R_objects/modules_deMicheli_m_f")}
if(!exists("modules.dellOrso.m.f")) {modules.dellOrso.m.f <- readRDS("./../saved/R_objects/modules_dellOrso_m_f")}
