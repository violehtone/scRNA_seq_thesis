...
**Save as pdf**
```{r primary-data-gimp-modules-metabolic-genes-pdf}
# Gimp
...
**Save as pdf**
```{r deMicheli-gimp-modules-metabolic-genes-pdf}
# Gimp
...
**Save as pdf**
```{r visualization-deMicheli-gimp-without-skeletal-muscle-pdf}
# Gimp
...
**Save as pdf**
```{r dellOrso-gimp-modules-metabolic-genes-pdf}
# Gimp
...
**save as pdf**
```{r dellOrso-gimp-modules-metabolic-genes-no-pm-pdf}
# Gimp
...
if(!exists("modules.deMicheli.m")) {modules.deMicheli.m <- readRDS("./../saved/modules_deMicheli_m")}
if(!exists("modules.dellOrso.m")) {modules.dellOrso.m <- readRDS("./../saved/modules_dellOrso_m")}
if(!exists("modules.deMicheli.m.f")) {modules.deMicheli.m.f <- readRDS("./../saved/modules_deMicheli_m_f")}
if(!exists("modules.dellOrso.m.f")) {modules.dellOrso.m.f <- readRDS("./../saved/modules_dellOrso_m_f")}
...
# Load prediction objects
pred.deMicheli.important.genes <- readRDS("./../saved/pred_deMicheli_important_genes")
pred.dellOrso.important.genes <- readRDS("./../saved/pred_dellOrso_important_genes")
```
...
saveRDS(pred.deMicheli.important.genes, file = "./../saved/pred_deMicheli_important_genes")
saveRDS(pred.dellOrso.important.genes, file = "./../saved/pred_dellOrso_important_genes")
...
write.csv(control.markers, file = "./../saved/control_marker_metabolic_genes.csv")
...
# Save marker information to .csv file
write.csv(control.markers.wmw, file = "./../saved/control_marker_metabolic_genes_wmw.csv")
