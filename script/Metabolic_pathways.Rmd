...
modules.primary.m.f4 <- readRDS("./../saved/modules_primary_m_f4")
...
# Modules extracted with >=4 modules
modules.primary.m.f4 <- extract_modules(expr_sel.deMicheli.m.f,
                                        time = traj.deMicheli.f.time,
                                        verbose = FALSE,
                                        G = 4:9)

saveRDS(modules.primary.m.f4, file = "./../saved/modules_primary_m_f4")
```
...
# Modules but number of modules set to 4
pdf("./../saved/modules_heatmap_deMicheli_metabolic_genes_no_muscle_g4.pdf")
draw_trajectory_heatmap(expr_sel.deMicheli.m.f, 
                        time = traj.deMicheli.f.time,
                        progression_group = group_name.deMicheli.m.f,
                        modules = modules.primary.m.f4,
                        show_labels_row = TRUE,
                        fontsize_row = 5,
                        fontsize = 4)
dev.off()
