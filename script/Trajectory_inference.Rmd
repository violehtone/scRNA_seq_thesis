...
```{r primary-data-cc-traj-inference-subset-of-samples, eval=FALSE}
...
**Expression of marker genes**
```{r primary-data-cc-traj-inference-subset-of-samples-marker-genes, eval=FALSE}
# Abundance of some marker genes
...
```{r dellOrso-traj-inference-without-primary-mb, eval=FALSE}
