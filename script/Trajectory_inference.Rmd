...
Here, we perform trajectory inference using Scorpius (https://github.com/rcannood/SCORPIUS). The aim is to computationally model the myogenic differentiation trajectory and to see if the cells in our primary data show trajectory-like progression from one cell state to another.

Also, we identify genes that have high importance in predicting the ordering of cells along the trajectories.
...
```{r cc-genes-seurat, eval=FALSE}
# Load G2/M- and S- phase marker genes
g2m.genes.mouse <- readRDS("./../saved/R_objects/cc_g2m_genes_mouse")
s.genes.mouse <- readRDS("./../saved/R_objects/cc_gs_genes_mouse")
...
saveRDS(cc.genes.osca, "./../saved/R_objects/cc_genes_osca")
```


**Inspect the cell cycle genes from OSCA and Seurat pipelines**
```{r cc-genes-comparison, eval=FALSE}
...
# Custom colors
colpalette.primary <- RColorBrewer::brewer.pal(5, "Set1")
...
```{r primary-data-traj-inference, warning=FALSE, message=FALSE}
# Load / create expression object
try(expression.primary <- readRDS("./../saved/R_objects/expression_primary"), silent = TRUE)

if(!exists("expression.primary")) {
  expression.primary <- as.matrix(t(logcounts(denoised.sce)))
  saveRDS(expression.primary, file = "./../saved/R_objects/expression_primary")
}

# Define group names
group_name.primary <- as.factor(denoised.sce$sample)

# Load / compute reduced dimensions
try(space.primary <- readRDS("./../saved/R_objects/space_primary"), silent = TRUE)
if(!exists("space.primary")) {
  set.seed(123)
  space.primary <- reduce_dimensionality(expression.primary, dist = "spearman", ndim = 2)
  saveRDS(space.primary, file = "./../saved/R_objects/space_primary")
}

# Trajectory inference
try(traj.primary <- readRDS("./../saved/R_objects/traj_primary"), silent = TRUE)
if(!exists("traj.primary")) {
  set.seed(123)
  traj.primary <- infer_trajectory(space.primary)
  traj.primary <- reverse_trajectory(traj.primary)
  saveRDS(traj.primary, file = "./../saved/R_objects/traj_primary")
}

# Plot the trajectory
p.primary <- draw_trajectory_plot(space = space.primary, 
...
draw_trajectory_plot(space = space.primary, 
                     progression_group = as.factor(denoised.sce$cluster.cc),
                     path = traj.primary$path,
                     point_size = 1,
                     point_alpha = 0.5,
                     contour = TRUE) +
  ggtitle("Trajectory inference",
          subtitle = "Primary dataset: All genes (ndim = 2) - Clusters") +
  theme(plot.title = element_text(size = 20, face = "bold"),
        plot.subtitle = element_text(size = 14),
        axis.title = element_text(size = 16))

# Highlight cc cluster 5
colpalette.cluster <- c("#778899", "#778899", "#778899","#778899", "#E41A1C")
names(colpalette.cluster) <- c("1", "2", "3", "4", "5")

draw_trajectory_plot(space = space.primary, 
                     progression_group = as.factor(denoised.sce$cluster.cc),
                     progression_group_palette = colpalette.cluster,
                     path = traj.primary$path,
                     point_size = 1,
                     point_alpha = 0.7,
                     contour = TRUE) +
  ggtitle("Trajectory inference",
          subtitle = "Primary dataset: All genes (ndim = 2) - Cluster 5 highlighted on red") +
  theme(plot.title = element_text(size = 20, face = "bold"),
        plot.subtitle = element_text(size = 14),
        axis.title = element_text(size = 16))
```
...
prog.groups <- list(cdh15 = expression.primary[, "Cdh15"],
                    ...
                    tnnt2 = expression.primary[, "Tnnt2"],
                    tnnt3 = expression.primary[, "Tnnt3"],
                    pax7 = expression.primary[, "Pax7"],
                    hes1 = expression.primary[, "Hes1"],
                    myf5 = expression.primary[, "Myf5"],
                    myod = expression.primary[, "Myod1"],
                    ccne1 = expression.primary[, "Ccne1"],
                    eifs = expression.primary[, "Eif1"],
                    ccnd1 = expression.primary[, "Ccnd1"],
                    ccnd2 = expression.primary[, "Ccnd2"],
                    myog = expression.primary[, "Myog"],
                    cdkn1a = expression.primary[, "Cdkn1a"],
                    gas1 = expression.primary[, "Gas1"])
...
# Plot the results
p.marker.gene.plots <- gridExtra::grid.arrange(marker.gene.plots$cdh15, marker.gene.plots$tnnt1,
                                               marker.gene.plots$tnnt2, marker.gene.plots$tnnt3,
                                               marker.gene.plots$pax7, marker.gene.plots$hes1,
                                               ...
                                               marker.gene.plots$myog, marker.gene.plots$cdkn1a,
                                               marker.gene.plots$gas1, ncol = 2)

p.marker.gene.plots
```

**Trajectory inference with all genes (but only Control, Cap50, and Cap50_r16h groups)**
```{r primary-data-traj-inference-filtered}
# Create expression and sample objects
denoised.sce.f <- denoised.sce[, denoised.sce$sample %in% c("control", "cap50", "cap50_r16h")]
expression.primary.f <- as.matrix(t(logcounts(denoised.sce.f)))
group_name.primary.f <- as.factor(denoised.sce.f$sample)

# Trajectory inference
set.seed(123)
space.primary.f <- reduce_dimensionality(expression.primary.f, dist = "spearman", ndim = 2)
set.seed(123)
traj.primary.f <- infer_trajectory(space.primary.f)
traj.primary.f <- reverse_trajectory(traj.primary.f)

# Plot the trajectory
draw_trajectory_plot(space = space.primary.f, 
                     progression_group = group_name.primary.f,
                     path = traj.primary.f$path,
                     point_size = 1,
                     point_alpha = 0.5,
                     contour = TRUE) +
  ggtitle("Trajectory inference",
          subtitle = "Primary dataset: All genes (ndim = 2), Only control, cap50, and cap50_r16h samples - Cell types") +
  theme(plot.title = element_text(size = 20, face = "bold"),
        plot.subtitle = element_text(size = 14),
        axis.title = element_text(size = 16))

# Marker genes
prog.groups <- list(cdh15 = expression.primary.f[, "Cdh15"],
                    tnnt1 = expression.primary.f[, "Tnnt1"],
                    tnnt2 = expression.primary.f[, "Tnnt2"],
                    tnnt3 = expression.primary.f[, "Tnnt3"],
                    pax7 = expression.primary.f[, "Pax7"],
                    hes1 = expression.primary.f[, "Hes1"],
                    myf5 = expression.primary.f[, "Myf5"],
                    myod = expression.primary.f[, "Myod1"],
                    ccne1 = expression.primary.f[, "Ccne1"],
                    eifs = expression.primary.f[, "Eif1"],
                    ccnd1 = expression.primary.f[, "Ccnd1"],
                    ccnd2 = expression.primary.f[, "Ccnd2"],
                    myog = expression.primary.f[, "Myog"],
                    cdkn1a = expression.primary.f[, "Cdkn1a"],
                    gas1 = expression.primary.f[, "Gas1"])

# Make plot for each gene
marker.gene.plots <- list()
for(gene in names(prog.groups)) {
  p <- draw_trajectory_plot(space = space.primary.f, 
                            progression_group = prog.groups[[gene]],
                            point_size = 0.5,
                            point_alpha = 0.5,
                            path = traj.primary.f$path,
...
```{r primary-data-cc-genes-traj-inference, eval=FALSE}
# Create expression and sample objects
...
# Plot the trajectory
p.primary.cc <- draw_trajectory_plot(space = space.primary.cc, 
                                     ...
                                     point_alpha = 0.4,
                                     contour = TRUE) +
                  ggtitle("Trajectory inference", subtitle = "Primary dataset (cc corrected): HVGs (ndim = 2) - samples") +
                  theme(plot.title = element_text(size = 20, face = "bold"),
...
draw_trajectory_plot(space = space.primary.cc, 
                     ...
                     point_alpha = 0.4,
                     contour = TRUE) +
  ggtitle("Trajectory inference", subtitle = "Primary dataset (cc corrected): HVGs (ndim = 2) - clusters") +
  theme(plot.title = element_text(size = 20, face = "bold"),
        plot.subtitle = element_text(size = 16),
        legend.text = element_text(size = 16),
        legend.title = element_text(size = 20, face = "bold"),
...
prog.groups <- list(cdh15 = expression.primary.cc.f[, "Cdh15"],
                    ...
                    tnnt2 = expression.primary.cc.f[, "Tnnt2"],
                    tnnt3 = expression.primary.cc.f[, "Tnnt3"],
                    pax7 = expression.primary.cc.f[, "Pax7"],
                    hes1 = expression.primary.cc.f[, "Hes1"],
                    myf5 = expression.primary.cc.f[, "Myf5"],
                    myod = expression.primary.cc.f[, "Myod1"],
                    ccne1 = expression.primary.cc.f[, "Ccne1"],
                    eifs = expression.primary.cc.f[, "Eif1"],
                    ccnd1 = expression.primary.cc.f[, "Ccnd1"],
                    ccnd2 = expression.primary.cc.f[, "Ccnd2"],
                    myog = expression.primary.cc.f[, "Myog"],
                    cdkn1a = expression.primary.cc.f[, "Cdkn1a"],
                    gas1 = expression.primary.cc.f[, "Gas1"])
...
**Free space by removing primary data sce objects**
```{r remove-primary-sces}
remove(denoised.sce)
remove(denoised.sce.cc)
```
...
p.deMicheli <- draw_trajectory_plot(space = space.deMicheli, 
...
```{r deMicheli-traj-inference-phases}
...
```{r deMicheli-traj-inference-cc-genes-Seurat, eval=FALSE}
# Create expression and sample objects
...
```{r deMicheli-traj-inference-cc-genes-OSCA, eval=FALSE}
...
**Free space by removing deMicheli data sce objects**
```{r remove-deMicheli-sces}
remove(denoised.sce.deMicheli)
remove(denoised.sce.deMicheli.cc)
```
...
**Marker genes**
```{r dellOrso-traj-inference-marker-genes}
# Abundance of some marker genes
...
gridExtra::grid.arrange(marker.gene.plots$pax7, marker.gene.plots$hes1,
                        ...
                        marker.gene.plots$gas1, ncol = 3)
```


#### 2.3.2 Trajectory inference without OSCA cc genes
```{r dellOrso-traj-inference-cc-genes, eval=FALSE}
# Create expression and sample objects
...
**Plot trajectory by cell cycle phases**
```{r dellOrso-traj-inference-cc-corrected-phases}
...
# plot trajectory
p.dellOrso <- draw_trajectory_plot(space = space.dellOrso.f, 
...
**Free space by removing deMicheli data sce objects**
```{r remove-dellOrso-sces}
remove(denoised.sce.dellOrso)
remove(denoised.sce.dellOrso.cc)
remove(denoised.sce.dellOrso.f)
```
...
```{r load-primary-data-gimp-modules}
# Load gimp and modules objects
gimp <- readRDS("./../saved/R_objects/gimp")
modules <- readRDS("./../saved/R_objects/modules")

gimp$qvalue <- p.adjust(p = gimp$pvalue, method = "BH")
gene_sel <- gimp$gene[gimp$qvalue < .05]
expr_sel <- scale_quantile(expression.primary[, gene_sel])

# Write gimp & module into tables
write.csv(gimp[gimp$gene %in% gene_sel, ], file = "./../saved/tables/gimp_primary.csv")
write.csv(modules, file = "./../saved/tables/modules_primary.csv")
```
...
#saveRDS(modules, file = "./../saved/R_objects/modules")
#saveRDS(gimp, file = "./../saved/R_objects/gimp")
```
...
pdf("./../saved/figures/gimp_heatmap_primary_data.pdf")
...
# Visualize modules
pdf("./../saved/figures/modules_heatmap_primary_data.pdf")
draw_trajectory_heatmap(expr_sel, 
                        time = traj.primary$time,
                        progression_group = group_name.primary,
                        modules = modules,
...
# Write gimp & module into tables
write.csv(gimp.deMicheli[gimp.deMicheli$gene %in% gene_sel.deMicheli, ], file = "./../saved/tables/gimp_deMicheli.csv")
write.csv(modules.deMicheli, file = "./../saved/tables/modules_deMicheli.csv")
```
...
#saveRDS(modules.deMicheli, file = "./../saved/R_objects/modules_deMicheli")
#saveRDS(gimp.deMicheli, file = "./../saved/R_objects/gimp_deMicheli")
```

#### 3.2.3 Visualization of gene importances (in pdf format)
```{r DeMicheli-gimp-modules-visualization, eval=FALSE}
# Visualize expression of selected genes
pdf("./../saved/figures/gimp_heatmap_deMicheli.pdf")
...
# Visualize modules
pdf("./../saved/figures/modules_heatmap_deMicheli.pdf")
draw_trajectory_heatmap(expr_sel.deMicheli, 
                        time = traj.deMicheli$time,
                        progression_group = group_name.deMicheli,
...
```{r load-marker-genes-dellOrso-all-genes}
# Load gimp and modules objects
gimp.dellOrso <- readRDS("./../saved/R_objects/gimp_dellOrso")
modules.dellOrso <- readRDS("./../saved/R_objects/modules_dellOrso")
...
# Write gimp & module into tables
write.csv(gimp.dellOrso[gimp.dellOrso$gene %in% gene_sel.dellOrso, ], file = "./../saved/tables/gimp_dellOrso.csv")
write.csv(modules.dellOrso, file = "./../saved/tables/modules_dellOrso.csv")
```

```{r load-marker-genes-dellOrso-without-PMs, eval=FALSE}
# Load gimp and modules objects
gimp.dellOrso.f <- readRDS("./../saved/R_objects/gimp_dellOrso_f")
modules.dellOrso.f <- readRDS("./../saved/R_objects/modules_dellOrso_f")
...
# Write gimp & module into tables
write.csv(gimp.dellOrso.f[gimp.dellOrso.f$gene %in% gene_sel.dellOrso.f, ], file = "./../saved/tables/gimp_dellOrso_f.csv")
write.csv(modules.dellOrso.f, file = "./../saved/tables/modules_dellOrso_f.csv")
```
...
#saveRDS(modules.dellOrso, file = "./../saved/R_objects/modules_dellOrso")
#saveRDS(gimp.dellOrso, file = "./../saved/R_objects/gimp_dellOrso")
```

#### 3.2.3 Visualization of gene importances: All cells (in pdf format)
```{r DellOrso-gimp-modules-visualization, eval=FALSE}
# Visualize expression of selected genes
pdf("./../saved/figures/gimp_heatmap_dellOrso.pdf")
...
# Visualize modules
pdf("./../saved/figures/modules_heatmap_dellOrso.pdf")
draw_trajectory_heatmap(expr_sel.dellOrso, 
                        time = traj.dellOrso$time,
                        progression_group = group_name.dellOrso,
...
#saveRDS(modules.dellOrso.f, file = "./../saved/R_objects/modules_dellOrso_f")
#saveRDS(gimp.dellOrso.f, file = "./../saved/R_objects/gimp_dellOrso_f")
```
...
# Visualize expression of selected genes
pdf("./../saved/figures/gimp_heatmap_dellOrso_f.pdf")
...
# Visualize modules
pdf("./../saved/figures/modules_heatmap_dellOrso_f.pdf")
draw_trajectory_heatmap(expr_sel.dellOrso.f, 
                        time = traj.dellOrso.f$time,
                        progression_group = group_name.dellOrso.f,
...
## 4. Saving of trajectory plots as R objects
```{r saving-of-traj-plots, eval=FALSE}
# Save plots as R objects without titles
p.primary <- p.primary + ggtitle("", subtitle = "") + theme(legend.text = element_text(size = 16),
                                                            legend.title = element_text(size = 20, face = "bold"),
                                                            axis.title = element_text(size = 16))

saveRDS(p.primary, "./../saved/R_objects/trajectory_plot_primary")

p.primary.cc <- p.primary.cc + ggtitle("", subtitle = "")
saveRDS(p.primary.cc, "./../saved/R_objects/trajectory_plot_primary_cc")

p.deMicheli <- p.deMicheli + ggtitle("", subtitle = "") + theme(legend.text = element_text(size = 16),
                                                                legend.title = element_text(size = 20, face = "bold"),
                                                                axis.title = element_text(size = 16))

saveRDS(p.deMicheli, "./../saved/R_objects/trajectory_plot_deMicheli")

p.dellOrso <- p.dellOrso + ggtitle("", subtitle = "") + theme(legend.text = element_text(size = 16),
                                                              legend.title = element_text(size = 20, face = "bold"),
                                                              axis.title = element_text(size = 16))
saveRDS(p.dellOrso, "./../saved/R_objects/trajectory_plot_dellOrso_f")
```
