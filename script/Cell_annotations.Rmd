...
pred.segments <- readRDS("./../saved/pred_segments")
...
# Remove low-quality cells
to.remove <- pruneScores(pred.segments, min.diff.med = 0.2)
...
pred.segments.d5 <- readRDS("./../saved/pred_segments_d5")
...
### De Micheli: segments on trajectory
